...
import eo.cn.yxwuliu.util.TextViewUtils;
...
public class TitleBarView extends LinearLayout {
	...
	private OnTitleTxtClickListener mTitleTxtClickListener;
	...
	private void setListener() {
		...
		mTitle.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				if (mTitleTxtClickListener != null) {
					mTitleTxtClickListener.onClick();
				}
			}
		});
	...
	public void setOnTitleTxtClickListener(
			OnTitleTxtClickListener listener) {
		mTitleTxtClickListener = listener;
	}
	...
	public interface OnTitleTxtClickListener {
		void onClick();
	}
